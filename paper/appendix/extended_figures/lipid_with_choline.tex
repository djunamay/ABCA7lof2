\begin{figure}[ht]
    ...
    \begin{subfigure}[t]{.35\textwidth}
        \caption{}
        \includegraphics[width=\textwidth]{./main_plots/tg_carbons_with_choline_batch2.png}        
    \end{subfigure} 
    \begin{subfigure}[t]{.35\textwidth}
        \caption{}
        \includegraphics[width=\textwidth]{./main_plots/pc_unsat_with_choline_batch2.png}        
    \end{subfigure} 
    \begin{subfigure}[t]{.35\textwidth}
        \caption{}
        \includegraphics[width=\textwidth]{./main_plots/all_lipids_choline_batch2.png}        
    \end{subfigure} 
    \begin{subfigure}[t]{.35\textwidth}
        \caption{}
    ...
    \begin{subfigure}[t]{.35\textwidth}
        \caption{}
        \includegraphics[width=\textwidth]{./main_plots/tg_carbons_with_choline_batch1.png}        
    \end{subfigure} 
    

    %\includegraphics[width=\textwidth]{./main_plots/fig_3_tmp.png}  
    ...
    % \begin{subfigure}[t]{.5\textwidth}
    %     \caption{}
    %     \includegraphics[width=\textwidth]{new_lipid_data.png}        
    % \end{subfigure}  
    \caption{

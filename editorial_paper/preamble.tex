...
\ifPDFTeX
  ...
  \usepackage{mathptmx}   % Times text + maths for pdfLaTeX
\else                      % XeLaTeX / LuaLaTeX
  \usepackage{unicode-math}   % already loads fontspec
  \setmainfont{Times New Roman}            % text
  \setmathfont{TeX Gyre Termes Math}       % maths, looks like Times
\fi
...
\captionsetup[subfigure]{%
  ...
  labelsep    = colon,            % “a: Caption…”
  labelfont   = {sf,small,bf}, % Helvetica, 8 pt, bold
  textfont    = footnotesize,     % 10 pt legend text
...
\usepackage{titling}  % after hyperref, before \title{...}

% Flush-left title, author, date

...
\textcolor{blue}{We appreciate the reviewer's suggestion and have now included a more comprehensive analysis of potential batch effects and differences in Figure~\ref{fig:snRNA_batch_quality} and a discussion thereof in the supplementary text. We refer to both in the main text and provide exerpts below. We can confirm that only V3 chemistry was used for samples in Batch 1 and only V2 chemistry was used for samples in Batch 2.}
